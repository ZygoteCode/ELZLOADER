-- {"Name": "Title Mod (Ann's Gift)", "Type": "Before Login"}
-- This script allows you to get powerful sockets on your 'Ann's Gift' title.
...
CX2TitleManager.AddTitleInfo_LUA = function(self, data)
    ...
    if data then
        ...
        if data.m_iTitleID == 10 or data.m_iTitleID == 12270 then
